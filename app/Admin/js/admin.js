...
$(document).ready(function () {
  ...
  $(document).on("click", ".btnEditarUsu", function () {
    ...
    edusu_id = fila2.find("td:eq(0)").text();
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data == 1) {
          ...
          usuarios
            .row(fila2)
            .data([edusu_id, edusu_nombre_cmplt, edusu_email]);
        } else {
          console.log(data);
          alert("error");
        }
  ...
  $(document).on("click", ".btnEliminarUsu", function () {
    fila2 = $(this);
    usu_id = ($(this).closest("tr").find("td:eq(0)").text());
    console.log(usu_id);
...
$(document).ready(function (){
    ...
    $.ajax({
      ...
      success: function (data) {
        if ((data = "")) {
          ...
          devoluciones.row
            .add(["", ca_codigo_carpetadev, "", "", dc_date])
            .draw();
        }
      },
    });
  ...
  $(document).on("click", "#btnEditarDev", function () {
    ...
    dc_numero_item_Editdev = parseInt(fila3.find("td:eq(2)").text());
    fechaEditdev = fila3.find("td:eq(4)").text();
    
    $("#IDEditDev").val(IDEditDev);
    $("#dc_numero_item_Editdev").val(dc_numero_item_Editdev);
  ...
  $("#EditarDev").submit(function (k){
    ...
    var dc_numero_item_Editdev = $.trim($("#dc_numero_item_Editdev").val());
    ...
    $.ajax({
      ...
      data: {
        IDEditDev: IDEditDev,
        dc_numero_item_Editdev: dc_numero_item_Editdev,
...
$(document).ready(function (){
  ...
  $("#agregar_mod").submit(function (l){
    ...
    cm_numero_item = $.trim($("#cm_numero_item").val());
  ...
  $(document).on("click", "#btnEditarMd", function () {
    ...
    var cm_numero_itemEditMd = parseInt(fila4.find("td:eq(1)").text());
    var cm_numero_foliosEditMd = fila4.find("td:eq(2)").text();
    var usu_idEditMd = fila4.find("td:eq(4)").text();
    var fechaEditMd = fila4.find("td:eq(3)").text();

    $("#ID").val(ID);
    $("#cm_numero_itemEditMd").val(cm_numero_itemEditMd);
    $("#cm_numero_foliosEditMd").val(cm_numero_foliosEditMd);
  ...
  $("#formEditMd").submit(function (n){
    ...
    var ID = $.trim($("#ID").val());
    var cm_numero_itemEditMd = $.trim($("#cm_numero_itemEditMd").val());
    var cm_numero_foliosEditMd = $.trim($("#cm_numero_foliosEditMd").val());
    ...
    $.ajax({
      ...
      data: {
        ID: ID,
        cm_numero_itemEditMd: cm_numero_itemEditMd,
        cm_numero_foliosEditMd: cm_numero_foliosEditMd,
      ...
      success: function (data) {
        ...
        if (data == 1) {
          ...
          modificacion
            ...
            .data([
              ID,
              cm_numero_itemEditMd,
              cm_numero_foliosEditMd,
              ,
              fechaEditMd,
              usu_idEditMd,
              "",
...
$(document).ready(function (){
  ...
  $("#FormAddPrestamo").submit(function (n) {
    ...
    numero_item = $.trim($("#numero_item").val());
    ...
    $.ajax({
      ...
      success: function (data) {
        if (data) {
          ...
          solicitudes.row
            .add([, id_usuario, numero_item, fecha_inicio, fecha_final])
            .draw();
        }
      },
    });
  ...
  $(document).on("click", "#btnEditsol", function () {
    ...
    var id_usuarioEdit = fila5.find("td:eq(1)").text();
    var numero_itemEdit = fila5.find("td:eq(2)").text();
    var fecha_inicioEdit = fila5.find("td:eq(3)").text();
    var fecha_finalEdit = fila5.find("td:eq(4)").text();

    $("#IDEdit").val(IDEdit);
    $("#numero_itemEdit").val(numero_itemEdit);
  ...
  $("#FormEditPrestamo").submit(function (m){
    ...
    var numero_itemEdit = $.trim($("#numero_itemEdit").val());
    ...
    $.ajax({
      ...
      data: {
        ...
        numero_itemEdit: numero_itemEdit,
  ...
  $(document).on("click", "#btnElmsol", function () {
    ...
    numero_itemEliminar = parseInt($(this).closest("tr").find("td:eq(2)").text());
    
    console.log(IDeliminar);
    console.log(numero_itemEliminar);
    ...
    if (respuesta) {
      ...
      $.ajax({
        ...
        data: {
          ...
          numero_itemEliminar: numero_itemEliminar,
        },
        success: function (data) {
          console.log(data);
