                    ...
                    <div class="tableresponsive">
                        <table class="table table-dark">
                            ...
                            <tbody>
                                ...
                                $sql = mysqli_query($con, "SELECT usu.usu_nombre_cmplt, dc.`dc_codigo_carpeta`, ca.`ca_nombre_carpeta` ,ca.`ca_tipo_carpeta`, dc.`dc_fecha_devolucion` FROM usuarios usu INNER JOIN devolucion_carpeta dc ON dc.`dc_id_usuario` = usu.`usu_id` INNER JOIN carpetas ca ON ca.`ca_codigo_carpeta` = dc.`dc_codigo_carpeta`");
