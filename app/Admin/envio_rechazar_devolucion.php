...
if (empty($_SESSION['ID_Ad'])) {
    ...
    <?php 
        ...
        try {
            ...
            $query = mysqli_query($con, "DELETE FROM devolucion_carpeta WHERE dc_codigo_carpeta = '$dc_codigo_carpeta' AND dc_id_usuario = '$usu_id'");

            //echo 'Message has been sent';
            echo "<script> alert('Se ha Enviado al usuario y eliminado su devolución.');
