...
<?php
    ...
    $insert = mysqli_query($con, "INSERT INTO devolucion_carpeta(ID, dc_codigo_carpeta, dc_id_usuario, dc_fecha_devolucion) VALUES (NULL, '$ca_codigo_carpetadev', '$usu_iddev', '$fechadev')");
    ...
    $select = mysqli_query($con, "SELECT * FROM devolucion_carpeta ORDER BY dc_codigo_carpeta DESC LIMIT 1");
