...
<?php
    ...
    $insert_crpt = mysqli_query($con, "INSERT INTO carpetas_modificadas(ID,cm_codigo_carpeta,cm_id_usuario,cm_folios_agregados,cm_fecha)VALUES(NULL,'$cm_codigo_carpeta','$cm_id_usuario','$cm_folios_agregados','$cm_fecha')");
    ...
    $select = mysqli_query($con, "SELECT * FROM carpetas_modificadas ORDER BY cm_codigo_carpeta DESC LIMIT 1");
